...
export namespace Prisma {
  ...
  */
  ...
  export type ShippingGetPayload<S extends boolean | null | undefined | ShippingArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Shipping :
    S extends undefined ? never :
    S extends { include: any } & (ShippingArgs | ShippingFindManyArgs)
    ? Shipping 
    : S extends { select: any } & (ShippingArgs | ShippingFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof Shipping ? Shipping[P] : never
  } 
      : Shipping


  type ShippingCountArgs = 
  ...
  export interface ShippingDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Shipping'> extends True ? Prisma__ShippingClient<ShippingGetPayload<T>> : Prisma__ShippingClient<ShippingGetPayload<T> | null, null>
    ...
    **/
    ...
    ): Prisma__ShippingClient<ShippingGetPayload<T>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Shipping'> extends True ? Prisma__ShippingClient<ShippingGetPayload<T>> : Prisma__ShippingClient<ShippingGetPayload<T> | null, null>
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<ShippingGetPayload<T>>>
   ...
   */
  export class Prisma__ShippingClient<T, Null = never> implements Prisma.PrismaPromise<T> {
   ...
   */
  export type ShippingFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Shipping
     */
    select?: ShippingSelect | null
   ...
   */
  export type ShippingFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Shipping
     */
    select?: ShippingSelect | null
  ...
  export type ShippingWhereInput = {
    ...
    trackingNumber?: StringFilter | string
    shippingAddress?: StringFilter | string
    status?: StringFilter | string
    currentLocation?: StringFilter | string
  ...
  export type ShippingScalarWhereWithAggregatesInput = {
    ...
    trackingNumber?: StringWithAggregatesFilter | string
    shippingAddress?: StringWithAggregatesFilter | string
    status?: StringWithAggregatesFilter | string
    currentLocation?: StringWithAggregatesFilter | string
